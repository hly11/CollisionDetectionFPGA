...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input2_TDATA { I 32 vector } input2_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input2_TREADY { O 1 bit } input2_TDEST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { img_data_stream_V_din { O 32 vector } img_data_stream_V_full_n { I 1 bit } img_data_stream_V_write { O 1 bit } } \
} "
}
