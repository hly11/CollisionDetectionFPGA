...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_control_bus input_stream input2"
    }
    ap_rst_n {
        type "reset"
        polarity "ACTIVE_LOW"
