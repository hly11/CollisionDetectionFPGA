...
architecture behave of image_filter_control_bus_s_axi is
    ...
    constant ADDR_ROWS2_DATA_0 : INTEGER :=16#28#;
    constant ADDR_ROWS2_CTRL : INTEGER :=16#2c#;
    constant ADDR_COLS2_DATA_0 : INTEGER :=16#30#;
    constant ADDR_COLS2_CTRL : INTEGER :=16#34#;
    ...
    signal int_rows2           : UNSIGNED(31 downto 0);
    signal int_cols2           : UNSIGNED(31 downto 0);
...
begin
    ...
    begin
        if (ACLK'event and ACLK = '1') and ACLK_EN = '1' then
            if (ar_hs = '1') then
                ...
                when ADDR_ROWS2_DATA_0 =>
                    rdata_data <= RESIZE(int_rows2(31 downto 0), 32);
                when ADDR_COLS2_DATA_0 =>
                    rdata_data <= RESIZE(int_cols2(31 downto 0), 32);
                when others =>
                    rdata_data <= (others => '0');
                end case;
            end if;
    ...
    rows2 <= STD_LOGIC_VECTOR(int_rows2);
    cols2 <= STD_LOGIC_VECTOR(int_cols2);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_ROWS2_DATA_0) then
                    int_rows2(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_rows2(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_COLS2_DATA_0) then
                    int_cols2(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_cols2(31 downto 0));
                end if;
            end if;
        end if;
    end process;
