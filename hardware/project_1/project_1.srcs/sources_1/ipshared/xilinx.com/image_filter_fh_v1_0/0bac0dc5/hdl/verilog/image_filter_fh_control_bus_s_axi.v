...
`timescale 1ns/1ps
module image_filter_fh_control_bus_s_axi
#(parameter
...
localparam
    ...
    ADDR_FILTER_SIZE_DATA_0 = 6'h20,
    ADDR_FILTER_SIZE_CTRL   = 6'h24;
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_FILTER_SIZE_DATA_0: begin
                    rdata <= int_filter_size[31:0];
                end
            endcase
        end
    end
...
assign filter_size  = int_filter_size;
...
// int_filter_size[31:0]
always @(posedge ACLK) begin
    if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_FILTER_SIZE_DATA_0)
            int_filter_size[31:0] <= (WDATA[31:0] & wmask) | (int_filter_size[31:0] & ~wmask);
    end
end
