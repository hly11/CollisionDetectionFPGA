...
void XImage_filter_Set_filter_size(XImage_filter *InstancePtr, u32 Data);
u32 XImage_filter_Get_filter_size(XImage_filter *InstancePtr);
void XImage_filter_Set_do_filter(XImage_filter *InstancePtr, u32 Data);
u32 XImage_filter_Get_do_filter(XImage_filter *InstancePtr);
